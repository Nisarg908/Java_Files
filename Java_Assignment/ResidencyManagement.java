...
public class ResidencyManagement {
    public static void main(String[] args) throws Exception{
        Residency r1 = new Residency(101, "Jethalal Gada", 'B', 350000);
        Residency r2 = new Residency(102, "Jethalal Gada", 'B', 320000);
        Residency r3 = new Residency(101, "Krishnan Iyer", 'A', 410000);
        Residency r4 = new Residency(101, "Atmaram Bhide", 'C', 390000);
        Residency r5 = new Residency(001, "Tarak Mehta", 'B', 290000);
